...
export default defineComponent({
  name: "Contact",
  components: {
    ContactDetailItem: defineAsyncComponent(() => import('components/system/ContactDetailItem.vue')),
    ContactItem: defineAsyncComponent(() => import('components/system/ContactItem.vue'))
  },
  setup() {
